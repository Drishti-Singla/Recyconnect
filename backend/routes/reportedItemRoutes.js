...
const { validateId, validateReportedItem } = require('../middleware/validation');
...
router.post('/', authenticateToken, validateReportedItem, reportedItemController.createReportedItem);
