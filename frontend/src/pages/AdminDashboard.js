...
function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    // Check sessionStorage first (primary), then localStorage as fallback
    ...
    console.log('🔐 Auth data:', { 
      ...
      isAdmin, 
      isLoggedIn,
      source: sessionStorage.getItem('user') ? 'sessionStorage' : 'localStorage'
    });
    
    if (!userData || isAdmin !== 'true' || isLoggedIn !== 'true') {
      console.log('❌ Admin access denied. Redirecting to login...');
      // Preserve admin redirect intent
    ...
    <div style={{ backgroundColor: currentColors.background, minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', paddingTop: '60px' }}>
        ...
        <div style={{ flex: 1, padding: '20px' }}>
          ...
          {activeSection !== 'dashboard' && (
            <div>
              {activeSection === 'explore' && <AdminExplore />}
