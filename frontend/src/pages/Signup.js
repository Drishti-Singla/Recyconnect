...
function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      // Store user data in sessionStorage (auto-logout on browser close)
      ...
      alert('Account created successfully! Redirecting to explore page...');
      
      // Redirect to explore page for regular users
