  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const donationData = { 
        ...
        pickup_location: formData.pickupLocation, // Map pickupLocation to pickup_location
        anonymity: formData.anonymity || 'public', // Include anonymity preference
