...
function ReportUser() {
  ...
  // Prefill form if data passed from navigation
  useEffect(() => {
    if (location.state) {
      const { itemTitle, username, concernType, description } = location.state;
      setFormData(prev => ({
        ...prev,
        concernType: concernType || 'item',
        userInQuestion: username || '',
        itemInvolved: itemTitle || '',
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
          ...
          <form>
            ...
            <div style={{ marginBottom: '2rem' }}>
              <ImageUpload
                label="Evidence/Screenshot (Optional)"
