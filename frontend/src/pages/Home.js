...
function Home() {
  ...
  <div style={howItWorksParallax} ref={section2Ref}>
      ...
      {/* Footer */}
      <footer style={{ background: '#007bff', color: 'white', textAlign: 'center', padding: '1.5rem 0' }}>
        <div style={{ marginBottom: '0.5rem' }}>
          <a href="/terms" style={{ color: 'white', textDecoration: 'none', margin: '0 1rem', fontSize: '0.9rem' }}>
            Terms & Conditions
          </a>
          <span style={{ color: 'rgba(255,255,255,0.6)' }}>|</span>
          <a href="/contact" style={{ color: 'white', textDecoration: 'none', margin: '0 1rem', fontSize: '0.9rem' }}>
            Contact Us
          </a>
        </div>
